...
import requests, pytz, time, re, sys, json, random
...
# min_dict = {time_list[0]: 4000, time_list[1]: 8000, time_list[2]: 13000, time_list[3]: 18000, time_list[4]: 23000, time_list[5]: 26000, time_list[6]: 28000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
# max_dict = {time_list[0]: 7999, time_list[1]: 12999, time_list[2]: 16999, time_list[3]: 22999, time_list[4]: 25999, time_list[5]: 27999, time_list[6]: 29999}
min_dict = {time_list[0]: 2000, time_list[1]: 5000, time_list[2]: 8000, time_list[3]: 11000, time_list[4]: 14000, time_list[5]: 17000, time_list[6]: 20000}
max_dict = {time_list[0]: 4999, time_list[1]: 7999, time_list[2]: 10999, time_list[3]: 13999, time_list[4]: 16999, time_list[5]: 19999, time_list[6]: 22000}
# 设置结束
